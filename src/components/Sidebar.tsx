...
export default function Sidebar() {
  return (
    <aside className="flex h-full w-64 flex-col border-r border-gray-100 bg-white">
      <div className="flex items-center gap-3 border-b border-gray-50 px-5 py-5">
        ...
        <div>
          <span className="text-base font-semibold text-gray-800">Piñatería</span>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium transition-all ${
                isActive
                  ? 'bg-gradient-to-r from-fucsia-50 to-morado-50 text-fucsia-700 shadow-sm'
      ...
      <div className="border-t border-gray-50 px-5 py-4">
        <p className="text-center text-xs text-gray-300">v1.0.0</p>
      </div>
    </aside>
  )
}
